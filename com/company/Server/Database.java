...
import com.company.utils.Hashcode;
...
public class Database {
    ...
    public static void readData() throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            if (type_str != null && !type_str.isEmpty() && !type_str.equals("null"))
                type = TicketType.valueOf(type_str.toUpperCase());
    ...
    public ArrayList<String> AuthorizationUser(User user) throws SQLException {
        if (Server.checkAuthorization(user.getLogin()))
            return new ArrayList<>(Collections.singleton("This login is already authorized"));
        if (checkLogin(user)) {
