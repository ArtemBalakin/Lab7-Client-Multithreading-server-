...
import com.company.Commands.Command_ExecuteFile;
...
public class Receiver {
    ...
    public static ArrayList<String> printHelp() {
        ...
        for (A_command command : Server.getAvailableCommands()) {
    ...
    public synchronized static ArrayList<String> replace(int index, Ticket ticket, TreeSet<Ticket> collection, String login) throws CommandExecutionException, SQLException {
    ...
    public synchronized static void found(int index, TreeSet<Ticket> collection) throws IllegalArgumentException, CommandExecutionException {
    ...
    public synchronized static ArrayList<String> clear(TreeSet<Ticket> collection, String login) throws SQLException {
    ...
    public synchronized static ArrayList<String> remove(TreeSet<Ticket> collection, int index, String login) throws CommandExecutionException {
    ...
    public synchronized static ArrayList<String> remove(TreeSet<Ticket> collection, Ticket ticket, int i, String login) throws SQLException {
        if (i > 0) {
    ...
    public synchronized static ArrayList<String> add(Ticket ticket, String login) throws SQLException {
    ...
    public synchronized static ArrayList<String> save(TreeSet<Ticket> set, String path) throws IOException, CommandExecutionException {
    ...
    public synchronized static ArrayList<String> print(TreeSet<Ticket> set, Person person) {
        ArrayList<String> result = new ArrayList<>();
    ...
    public synchronized static ArrayList<String> print(TreeSet<Ticket> set, TicketType type) {
        ArrayList<String> result = new ArrayList<>();
        for (Ticket ticket : set) {
    ...
    public synchronized static ArrayList<String> ReadCommandFromFile(String path) throws UncorrectedScriptException, IOException {
